...
parser.add_argument("--max", default=DEFAULT_MAX, help="cycle peak value")
parser.add_argument("--min", default=DEFAULT_MAX/6, help="cycle minimum value, recommended max/6")
parser.add_argument("--len", default=10, help="cycle length, recommended (2-10) * steps_per_epoch")
parser.add_argument("--cycles", default=50, help="quantity of cycles to generate")
parser.add_argument("--decay", default=0.0, help="rate of decay")
parser.add_argument("--no-restarts", action="store_true", help="do full waves instead of half")
parser.add_argument("--start", default=2, help="wave start point; 0 for min; 1 for max; 2 for full wave followed by max")
parser.add_argument("--onecycle", default=0, help="1cycle phase length, 0 to disable")
parser.add_argument("--onecycle-min", default=DEFAULT_MAX/100, help="1cycle phase minimum")
parser.add_argument("--step-start", default=0, help="starting point for steps, useful for resuming training w/ a new schedule")
parser.add_argument("--wave", default=1, help="0 for triangle; 1 for sine")
